...
const carouselContent = [
  {
    ...
    imgPath: "https://fondosmil.com/fondo/2319.jpg",
  },
  {
    label: "lago de dia hermoso",
    imgPath: "https://fondosmil.com/fondo/11112.jpg",
  },
  {
...
export default function Home() {
  ...
  const elementRef = useNearScreen({
    distance: "0px",
    threshold: 0.2,
    root: null,
    externalRef: mainContainer,
  });
  ...
  return (
    <>
      <AppBar
        ...
        className="appBar"
        position="relative"
        sx={{ top: "-4rem", visibility: "hidden", zIndex: 0, opacity: "0" }}
      >
        <Toolbar>
      ...
      >
        ...
        <div id="container_p" className="container_p">
          <div className="container_logo">
            ...
            />
            <img className="full_logo" src={fullLogo} alt="logo fmunefm" />
            <h5 className="title_logo">FONDO DE MUTUALIDAD</h5>
            <h5 className="slogan">
              Transformando el sistema de salud de los trabajadores
              universitarios...
            </h5>
          </div>
        </div>
        <div className="container_button">
          <div id="scroll-container">
            <div id="scroll-text">
              10 de Junio de 2022 - tasa del dia $: 5,10 BsD - Planes: APS Plus
              (2$), APS Master (3$), APS Full (5$)
            </div>
          </div>
          <div className="button_group">
            ...
            {/* <button
              onClick={() => history.push("/medicine-donation")}
              className="button"
            >
      ...
      <div className="card_home">
        ...
        />
        {content.map((el, i) => (
          <p style={{ textAlign: "justify", margin: "15px" }} key={i}>
            {el}
          </p>
        ))}
      </div>
