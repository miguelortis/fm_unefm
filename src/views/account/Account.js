    ...
    async function getHistory() {
      ...
      try {
        const { data } = await axios.get(
          `${process.env.REACT_APP_TEST_URL}/sinister/sinisters?skip=${skip}&type=${type}&limit=${limit}`,
          {
            headers: {
        ...
        setHistorys({
          ...
          SH: {
            ...historys.SH,
            history: [...historys.SH.history, ...data.SH.history],
            IT: data.SH.IT,
          },
          PH: {
            ...historys.PH,
            history: [...historys.PH.history, ...data.PH.history],
            IT: data.PH.IT,
          },
          TH: {
            ...historys.TH,
            history: [...historys.TH.history, ...data.TH.history],
            IT: data.TH.IT,
          },
        });
